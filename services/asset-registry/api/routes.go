// Package api provides route definitions for the asset registry service.
package api
...
import (
	...
	"github.com/siem-soar-platform/services/asset-registry/internal/handler"
...
func NewRouter(assetService *service.AssetService, logger *slog.Logger) *Router {
...
func (r *Router) readyHandler(c *gin.Context) {
	...
	cacheStats, err := r.assetService.GetCacheStats(c.Request.Context())
	if err != nil {
...
func (r *Router) metricsHandler(c *gin.Context) {
	cacheStats, _ := r.assetService.GetCacheStats(c.Request.Context())
